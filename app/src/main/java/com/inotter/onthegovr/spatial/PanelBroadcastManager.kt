...
object PanelBroadcastManager {
    ...
    // Action constants
    const val ACTION_PLAY_PAUSE = "com.inotter.onthegovr.ACTION_PLAY_PAUSE"
    const val ACTION_SEEK = "com.inotter.onthegovr.ACTION_SEEK"
    const val ACTION_REWIND = "com.inotter.onthegovr.ACTION_REWIND"
    const val ACTION_FAST_FORWARD = "com.inotter.onthegovr.ACTION_FAST_FORWARD"
    const val ACTION_RESTART = "com.inotter.onthegovr.ACTION_RESTART"
    const val ACTION_MUTE_TOGGLE = "com.inotter.onthegovr.ACTION_MUTE_TOGGLE"
    const val ACTION_CLOSE = "com.inotter.onthegovr.ACTION_CLOSE"
    const val ACTION_LIGHTING_CHANGED = "com.inotter.onthegovr.ACTION_LIGHTING_CHANGED"
    const val ACTION_ENVIRONMENT_CHANGED = "com.inotter.onthegovr.ACTION_ENVIRONMENT_CHANGED"
    const val ACTION_TOGGLE_SETTINGS = "com.inotter.onthegovr.ACTION_TOGGLE_SETTINGS"
